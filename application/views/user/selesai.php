        ...
        <div class="col-md-4 col-sm-6 mb-3">
            ...
            <div class="card">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-right justify-content-between">
                    ...
                    <h7 class="text-dark" style="float: right;">Diserahkan</h7>
                </div>
                ...
                <div class="card-body">
                    <div class="card" style="max-width: 400px;">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <img src="<?= base_url('assets/img/main/kk.png') ?>" class="card-img" alt="...">
                            </div>
                            <div class="col-md-7">
                                <div class="card-body">
                                    <small class="card-title">PRETEST-PERTEMUAN ...</small><br>
                                    <small class="card-text">PDF</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    <form>
                        <div class="form-group row">
                            <div class="col-sm-10">
                                <div class="dropdown no-arrow">
                                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <button class="btn btn-light text-primary my-2" style="width: 23rem;">Batalkan penyerahan</button>
                                    </a>
                                </div>
                            </div>
