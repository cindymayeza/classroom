                    ...
                    <form>
                        <div class="form-group row">
                            <div class="col-sm-10">
                                <div class="dropdown no-arrow">
                                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <button class="btn btn-light text-primary my-2">+ Tambah atau Buat</button>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                                ...
                                <a href="" class="link-button btn btn-primary">Tandai Sebagai Selesai</a>
                            </div>
                    ...
                    <div class="tab-pane fade show active" id="terbaru" role="tabpanel" aria-labelledby="terbaru-tab">
                        <div class="card-deck">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="<?= base_url('user/tambah_file') ?>" class="card-title text-dark"><i class="fas fa-file-pdf text-danger mx-2"></i>Keamanan Komputer</a>
                                </div>
                            </div>
                            <div class="card">
